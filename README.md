...
🔏 Edit your smart contract `SPORK.sol` in `packages/hardhat/contracts`
...
🔲 Try making a `<Button/>` that calls `writeContracts.SPORK.setPurpose("👋 Hello World")` to explore how your UI might work...
...
🔏 Edit or rename your smart contract `SPORK.sol` in `packages/hardhat/contracts`
